...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
                        ...
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col-auto">
                                            <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">{{ $busCount }}
                                            </div>
                                        </div>
                                        <div class="col">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <a href="{{ route('customer.reservations') }}" style="text-decoration: none">
            ...
            <!-- Passengers Card Example -->
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card border-left-success shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Passengers</div>
                                <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $passengers }}</div>
                            </div>
                            <div class="col-auto">
    ...
    <script>
        ...
        var myPieChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    data: [55, 30, 15],
                    backgroundColor: ['#c50711', '#1cc88a', '#36b9cc'],
                    hoverBackgroundColor: ['#c50711', '#17a673', '#2c9faf'],
        ...
        var myLineChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    label: "Earnings",
                    lineTension: 0.3,
                    backgroundColor: "rgba(92, 1, 1, 0.05)",
                    borderColor: "#5c0101",
                    pointRadius: 3,
                    pointBackgroundColor: "#c50711",
                    pointBorderColor: "#c50711",
                    pointHoverRadius: 3,
